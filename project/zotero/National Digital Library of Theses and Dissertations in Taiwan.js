{
	"translatorID": "daf648ec-cdbc-4553-a974-63913f23b087",
	"label": "National Digital Library of Theses and Dissertations in Taiwan",
	"creator": "Pulipuli Chen",
	"target": "^http://ndltd.ncl.edu.tw/cgi-bin/gs32/gsweb.cgi",
	"minVersion": "1.0",
	"maxVersion": "",
	"priority": 100,
	"inRepository": true,
	...
	"lastUpdated": "2013-03-30 22:21:23"
}
...
FW.Scraper({ itemType         : 'thesis',
			 ...
			 language         : FW.Xpath('//*[text()[contains(.,"語文別:")]]/following-sibling::td[1]').text().trim()
			 	.addFilter(function (_s) {
				 	if (_s == "中文") {
				 		return "zh_TW";
				 	}
