{
	...
	"translatorType": 7,
	"browserSupport": "gcs",
	"lastUpdated": "2013-12-13 20:07:49"
}
...
FW.Scraper({ itemType         : 'thesis',
			  ...
			  */
			 creators         : FW.Xpath('//*[text()[contains(.,"研究生:")]]/following-sibling::td[1] | //*[text()[contains(.,"作者:")]]/following-sibling::td[1]').text().trim().split(/,/).cleanAuthor("author"),
