    ...
    $.infinitescroll.prototype = {
        ...
        */
        ...
        _showdonemsg: function infscr_showdonemsg() {
	    	...
	    	var _next_path = _get_next_path();
	    	if (_next_path.length > 0)
	    	{
	    		opts.loadingMsg.find(".loading-msg").attr("href", _next_path);
	    		opts.loadingMsg.find(".loading-msg").append($("<div>"+_next_path+"</div>"));
	    	}
