{
	"translatorID": "77915e1e-6b95-4754-bd48-8610f4b61b7f",
	"label": "Chinese Electronic Periodical Services",
	"creator": "Pulipuli Chen",
	"target": "http://www.airiti.com/ceps/ec/",
	"minVersion": "1.0",
	"maxVersion": "",
	"priority": 100,
	"inRepository": true,
	...
	"lastUpdated": "2013-03-30 18:43:52"
}
...
FW.Scraper({ itemType         : 'journalArticle',
			 detect           : FW.Xpath('//*[@id="uoutdata"]'),
			 //title            : FW.Xpath('//*[@id="format0_disparea"]/tbody/tr[3]/td').text().trim(),
			 //  //*[text()[contains(.,'ABC')]]
			 callNumber       : FW.Xpath('//*[text()[contains(.,"系統識別號")]]/parent::*/parent::*/following-sibling::td[1]').text().trim(),
			 title            : FW.Xpath('//*[text()[contains(.,"篇　名")]]/parent::*/parent::*/following-sibling::td[1]').text().trim(),
			 shortTitle       : FW.Xpath('//*[text()[contains(.,"並列篇名")]]/parent::*/parent::*/following-sibling::td[1]').text().trim(),
			 
			 creators         : FW.Xpath('//*[text()[contains(.,"作　者")]]/parent::*/parent::*/following-sibling::td[1]').text().trim()
			 	.addFilter(function (_s) {
			 		...
			 		for (var _i = 0; _i < _ss.lenght; _i++ ) {
			 			var _s = _ss[_i];
			 			
			 			var _header_pos = _s.indexOf(_header) + 1;
			 			var _footer_pos = _s.lastIndexOf(_footer_pos) - 1;	
			 			
			 			_s = _s.substr(_header_pos, _footer_pos);
			 		...
			 		*/
			 		...
			 		var _footer = ")";
			 		var _header_pos = _s.indexOf(_header) + 1;
		 			var _footer_pos = _s.lastIndexOf(_footer) - 1;	
			 		_s = _s.substr(_header_pos, _footer_pos);
			 		...
			 		*/
			 		...
			 		{
			 			_t = _ss[_i];
			 			var _footer_pos = _t.indexOf(_footer);
			 			_t = _t.substr(0, _footer_pos);
			 ...
			 publicationTitle  : FW.Xpath('//*[text()[contains(.,"刊　名")]]/parent::*/parent::*/following-sibling::td[1]').text().trim(),	
			 
			 volume            : FW.Xpath('//*[text()[contains(.,"卷期／出版年月")]]/parent::*/parent::*/following-sibling::td[1]').text().trim()
			 	.addFilter(function (_s) {
			 		//2卷4期(2009/12)
			 		//var _header = "(";
			 		var _header_pos = 0;
			 		var _footer = "卷";
			 		var _footer_pos = _s.indexOf(_footer);
			 		return _s.substr(_header_pos, _footer_pos);
			 	}),	
			 issue             : FW.Xpath('//*[text()[contains(.,"卷期／出版年月")]]/parent::*/parent::*/following-sibling::td[1]').text().trim()
			 	.addFilter(function (_s) {
			 		//2卷4期(2009/12)
			 		var _header = "卷";
			 		var _header_pos = _s.indexOf(_header)+1;
			 ...
			 date             : FW.Xpath('//*[text()[contains(.,"卷期／出版年月")]]/parent::*/parent::*/following-sibling::td[1]/font').text().trim()
			 	.addFilter(function (_s) {
			 		//2卷4期(2009/12)
			 		var _header = "(";
			 		var _header_pos = _s.indexOf(_header)+1;
			 		var _footer = ")";
			 		//var _footer_pos = _s.lastIndexOf(_footer)+1;
			 		var _footer_pos = _s.length-3;
			 		//return  _s.substr(_header_pos, _footer_pos);
			 		//return _footer_pos + "/" + _header_pos;
			 		_s = _s.substr(_header_pos, _footer_pos);
			 		_s = _s.substr(0, _s.length-1);
			 		return _s;
			 	}),	
			 pages            : FW.Xpath('//*[text()[contains(.,"頁次")]]/parent::*/parent::*/following-sibling::td[1]').text().trim(),	
			 language         : FW.Xpath('//*[text()[contains(.,"資料語文")]]/parent::*/parent::*/following-sibling::td[1]').text().trim()
			 	.addFilter(function (_s) {
				 	if (_s == "中文") {
				 		return "zh_TW";
				 	}
			 ...
			 abstractNote     : FW.Xpath('//*[text()[contains(.,"摘要")]]/parent::*/parent::*/following-sibling::td[1]').text().trim(),
			 accessDate       : "CURRENT_TIMESTAMP",
			 
			 tags             : FW.Xpath('//*[text()[contains(.,"關鍵詞")]]/parent::*/parent::*/following-sibling::td[1]').text().trim().split(","),
			 
			 rights            : FW.Xpath('//*[@id="container"]/table[7]/tbody/tr/td').text().trim(),
			 archive          : "Chinese Electronic Periodical Services"
  });
