...
function puliHandlePost()	{
	...
	pHP.load = function(nodeID)
	{
		...
		jQuery.getJSON("http://"+pHP.bloggerName+".blogspot.com/feeds/posts/summary"+tagname+"/?alt=json-in-script&callback=?", 
			function(data){ 
...
function puliHandleComments()	{
	...
	pHC.load = function(nodeID)
	{
		...
		jQuery.getJSON("http://"+pHC.bloggerName+".blogspot.com/feeds/comments/full?alt=json-in-script&callback=?", 
			function(data){ 
