{
	"translatorID": "0d6fbeb8-a7b6-4eec-8421-d2cbf5061a88",
	"label": "STPI Government Research Bulletin",
	"creator": "Pulipuli Chen",
	"target": "^http?://grbsearch\\.stpi\\.narl\\.org\\.tw/GRB/",
	"minVersion": "1.0",
	"maxVersion": "",
	"priority": 100,
	"inRepository": true,
	"translatorType": 5,
	"browserSupport": "gcsi",
	"lastUpdated": "2013-03-07 23:05:15"
}
...
/** Reportes */
FW.Scraper({ itemType         : 'report',
			 detect           : FW.Xpath('//*[@id="table1"]/tbody/tr[1]/td[2]'),
			 title            : FW.Xpath('//*[@id="table1"]/tbody/tr[1]/td[2]').text().trim(),
			 creators         : FW.Xpath('//*[@id="table1"]/tbody/tr[9]/td[2]').text().trim().split(/,/).cleanAuthor("author"),
			 abstractNote     : FW.Xpath('//*[@id="table1"]/tbody/tr[12]/td[2]').text().trim()
			 ...
			 reportType       : FW.Xpath('//*[@id="table1"]/tbody/tr[3]/td[4]').text().trim(),
			 date             : FW.Xpath('//*[@id="table1"]/tbody/tr[7]/td[2]').text().trim()
			 	.addFilter(function (_chinese_year) { 
			 		var _year = _chinese_year;
					var _footer = "年";
					if (_year.substr((_year.length-_footer.length) , _year.length) == _footer) {
						_year = _year.split(" ");
						_year = parseInt(_year, 10) + 1911;
					}
			 ...
			 // 無法正常運作，因為GRB沒辦法透過網址直接抓檔案
			  { 
			  	url : FW.Xpath('concat(string(//*[@id="table1"]/tbody/tr[7]/td[2]) ,"-", string(//*[@id="table1"]/tbody/tr[4]/td[2]))')
			 	.addFilter(function (_full) { 
			 		var _parts = _full.split('-');

			 		var _chinese_year = _parts[0];
					...
					var fName = "";
					fName = fName + _parts[1].substr(3);
					fName = fName + _parts[2];
					fName = fName + _parts[3];
					fName = fName + _parts[4] + ".pdf";

					path = "pdf\\\\" + _year + "\\\\" + fName;
					var a = "GetFile?path=" + path + "&dir=1&downloadFile="+fName + "&projkey=PF9208-0524&pnchDesc=%E4%BB%A5%E8%A9%A6%E9%A1%8C%E5%8F%8D%E6%87%89%E7%90%86%E8%AB%96%E7%82%BA%E5%9F%BA%E7%A4%8E%E5%BB%BA%E6%A7%8B%E5%85%B7%E5%80%8B%E4%BA%BA%E5%8C%96%E5%AD%B8%E7%BF%92%E6%A9%9F%E5%88%B6%E4%B9%8B%E7%B6%B2%E8%B7%AF%E7%B7%9A%E4%B8%8A%E5%AD%B8%E7%BF%92%E7%B3%BB%E7%B5%B1&ref_key=RN9403-0512&externalSource=";
					//a = unescape(a);
					a = "http://grbsearch.stpi.narl.org.tw/GRB/" + a;
					return a;
				}),
				title: FW.Xpath('//*[@id="table1"]/tbody/tr[1]/td[2]').text().trim(),
				...
				*/
				 { url: FW.Url(),
 					title:  FW.Xpath('//*[@id="table1"]/tbody/tr[1]/td[2]').text().trim().append(" Snapshot"),
 					type: "text/html" }
			  ],
			 tags             : [FW.Xpath('//*[@id="table1"]/tbody/tr[10]/td[2]').text().trim()
			 	...
			 	, FW.Xpath('//*[@id="table1"]/tbody/tr[11]/td[2]').text().trim()
			 		.addFilter(function (s) {
						if (_s == "--") {
				 			return "";
				 		} 
...
FW.MultiScraper({ itemType  : "multiple",
			 	  //detect    : FW.Xpath('//table[@class="sbody"]'),
			 	  ///html/body/form[2]/table[1]/tbody/tr/td/table[3]/tbody/tr[1]/td[1]/table[1]
			 	  detect    : FW.Xpath('//table[@class="sresult"]'),
			 	  choices : {
			 	  	///html/body/form[2]/table[1]/tbody/tr/td/table[3]/tbody/tr[1]/td[1]/table[1]
				 	//titles    : FW.Xpath('/html/body/form[2]/table[1]/tbody/tr/td/table[3]/tbody/tr[1]/td[1]/table/tbody/tr[1]/td[2]/a').text(),
				 	titles    : FW.Xpath('//a[@class="fresult"]').key('href').text(),
			 	  	urls    : FW.Xpath('//a[@class="fresult"]').key('href').text()
			 	  	//.replace(/amp;/, '')
			 	  	//.prepend("http://grbsearch.stpi.narl.org.tw/GRB/")
			 	  		...
			 	  		.addFilter(function (s) {
			 	  			...
			 	  			{
			 	  				_pos = s[i].indexOf(_needle) - 4;
			 	  				s[i] = s[i].substr(0, _pos);
			 	  				s[i] = "result.jsp?id=1680148&amp;plan_no=NSC97-2517-S166-001&amp;plan_year=97&amp;projkey=PF9709-1059&amp;target=plan";
			 	  			}
			 	  			//s = s.substr(0, _pos);
			 	  			//return "http://grbsearch.stpi.narl.org.tw/GRB/result.jsp?id=995439&plan_no=NSC93-2411-H364-001&plan_year=93&projkey=PE9308-0844&target=plan&highStr=%E9%99%B3&check=0&pnchDesc=%E9%80%A2%E8%AE%8A%E4%B9%8B%E9%9A%9B%EF%BC%9A1940%E5%B9%B4%E4%BB%A3%E4%B8%AD%E8%A5%BF%E5%8F%B2%E5%AE%B6%E5%8F%8A%E5%8F%B2%E5%AD%B8%E6%80%9D%E6%83%B3%E4%B9%8B%E7%A0%94%E7%A9%B6---%E8%90%AC%E9%87%8C%E4%B9%BE%E5%9D%A4%E8%BF%B7%E5%8E%BB%E4%BD%8F%EF%BC%9A1940%E5%B9%B4%E4%BB%A3%E9%99%B3%E5%AF%85%E6%81%AA%E5%8F%B2%E5%AD%B8%E8%88%87%E4%BA%BA%E7%94%9F%E7%9A%84%E8%BD%89%E6%8A%98%28I%29";
			 	  			//return encodeURI("http://grbsearch.stpi.narl.org.tw/GRB/result.jsp?id=995439&plan_no=NSC93-2411-H364-001&plan_year=93&projkey=PE9308-0844&target=plan");
			 	  			return s;
			 	  		})
...
var testCases = [
	{
		"type": "web",
		"url": "http://grbsearch.stpi.narl.org.tw/GRB/result.jsp?id=855747&plan_no=NSC92-2520-S026-002&plan_year=92&projkey=PF9208-0524&target=plan&highStr=%E9%99%B3%E5%BF%97%E9%8A%98&check=0&pnchDesc=%E4%BB%A5%E8%A9%A6%E9%A1%8C%E5%8F%8D%E6%87%89%E7%90%86%E8%AB%96%E7%82%BA%E5%9F%BA%E7%A4%8E%E5%BB%BA%E6%A7%8B%E5%85%B7%E5%80%8B%E4%BA%BA%E5%8C%96%E5%AD%B8%E7%BF%92%E6%A9%9F%E5%88%B6%E4%B9%8B%E7%B6%B2%E8%B7%AF%E7%B7%9A%E4%B8%8A%E5%AD%B8%E7%BF%92%E7%B3%BB%E7%B5%B1",
		"items": [
			{
				"itemType": "report",
				"title" : "以試題反應理論為基礎建構具個人化學習機制之網路線上學習系統",
				"creators": [
					{
						"firstName": "陳志銘",
						"creatorType": "author"
				...
				"attachments": [
					{
						"title": "以試題反應理論為基礎建構具個人化學習機制之網路線上學習系統 Snapshot",
						"type": "text/html"
					}
				],
				"url": "http://grbsearch.stpi.narl.org.tw/GRB/result.jsp?id=855747&plan_no=NSC92-2520-S026-002&plan_year=92&projkey=PF9208-0524&target=plan&highStr=%E9%99%B3%E5%BF%97%E9%8A%98&check=0&pnchDesc=%E4%BB%A5%E8%A9%A6%E9%A1%8C%E5%8F%8D%E6%87%89%E7%90%86%E8%AB%96%E7%82%BA%E5%9F%BA%E7%A4%8E%E5%BB%BA%E6%A7%8B%E5%85%B7%E5%80%8B%E4%BA%BA%E5%8C%96%E5%AD%B8%E7%BF%92%E6%A9%9F%E5%88%B6%E4%B9%8B%E7%B6%B2%E8%B7%AF%E7%B7%9A%E4%B8%8A%E5%AD%B8%E7%BF%92%E7%B3%BB%E7%B5%B1",
				"date": "2003",
				"reportNumber" : "NSC92-2520-S026-002",
				"institution": "國立花蓮師範學院數學教育學系",
				"accessDate": "CURRENT_TIMESTAMP"
			}
		]
	}
